...
--
-- Host: localhost:3306
-- Generation Time: Jul 23, 2018 at 08:34 PM
...
--
-- Database: `trip_advisor_test`
--
CREATE DATABASE IF NOT EXISTS `trip_advisor_test` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;
USE `trip_advisor_test`;
